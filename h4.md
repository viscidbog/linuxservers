...
## x) Yleistä pilvipalvelien käytöstä
...
Lisätessä oikeuksia saatiin sudo- ja admn-oikeudet käyttäjälle, mutta adminia lisätessä tuli errori, eli sitä grouppia ei siis virtuaalipalvelimella ole:

<img width="821" height="418" alt="image" src="https://github.com/user-attachments/assets/adf1e8a5-b96b-4b60-a2ec-c5d7ee1fc742" />

<br></br>

Ja uudella käyttäjällä yrittäessä SSH-yhteyssä, se ei toimi:
